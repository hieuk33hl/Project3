                        ...
                        <div class="content">
                            ...
                            <form method="POST" action="{{ URL::to('/save-supplier') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" placeholder="ID nhà cung cấp" class="form-control" readonly="readonly">
                                </div>
                                <div class="form-group">
                                    <label>Tên nhà cung cấp</label>
                                    <input type="text" placeholder="Tên nhà cung cấp" class="form-control" name="supplier_name">
                                </div>
                                <div class="form-group">
                                    <label>Địa chỉ</label>
